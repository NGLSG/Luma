...
* [核心特性与性能概览](#核心特性与性能概览)
  ...
  * [功能一览](#功能一览)
* [技术栈](#技术栈)
* [渲染系统说明（新增 Nut 渲染器）](#渲染系统说明新增-nut-渲染器)
* [Shader 模块系统（新增）](#shader-模块系统新增)
* [快速开始](#快速开始)
* [编辑器断点调试支持](#编辑器断点调试支持)
* [核心系统概述](#核心系统概述)
* [项目状态与路线图](#项目状态与路线图)
...
|  中  | Nut 渲染器 API 公布 | 开发中 | 2025 Q3 |
|  中  | 自定义材质编辑器       | 计划中 | 2025 Q4 |
|  低  | 编辑器 UI 现代化     | 研究中 | 2025 Q4 |
|  低  | 2D 粒子系统        | 计划中 | 2025 Q4 |
